      ...
      <section className="section-about-me">
        ...
        <article>
          ...
          <p>
            ...
            and that was the spark I needed to begin studying computer science.
          </p>
          ...
          <p>
            ...
            the backend developers of the project and been creating new Webapps,
            creating new databases for the Oracle Sql part of the app and even
            been using Elastic Search.
          </p>
          ...
          <p>
            My most recent project is a Demo of a Blog, that contains a CMS part
            to create new information for the site.
          </p>
